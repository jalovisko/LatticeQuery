...
def fbcc_diagonals(unit_cell_size: np.float64,
					strut_radius: np.float64) -> cq.cq.Workplane:
	"""
	Creates a solid model of the diagonals in a FBCC unit cell.
...
cq.Workplane.fbcc_diagonals = fbcc_diagonals

def fbcc_vertical_struts(unit_cell_size: np.float64,
						strut_radius: np.float64) -> cq.cq.Workplane:
	"""
	...
	return result
# Register our custom plugin before use.
cq.Workplane.fbcc_vertical_struts = fbcc_vertical_struts

def fbcc_bottom_horizontal_struts(unit_cell_size, strut_radius):
	result = cq.Workplane("XY")
	angle = 90
	corner_points = unit_cell_size * np.array(
		[(0, 0),
	...
	return result
# Register our custom plugin before use.
cq.Workplane.fbcc_bottom_horizontal_struts = fbcc_bottom_horizontal_struts

def fbcc_horizontal_diagonal_struts(unit_cell_size, strut_radius):
	result = cq.Workplane("XY")
	corner_points = unit_cell_size * np.array(
		[(0, 0, 0),
		(1, 0, 0),
	...
	return result
# Register our custom plugin before use.
cq.Workplane.fbcc_horizontal_diagonal_struts = fbcc_horizontal_diagonal_struts

def fbcc_top_horizontal_struts(unit_cell_size, strut_radius):
	result = cq.Workplane("XY")
	angle = 90
	corner_points = unit_cell_size * np.array(
		[(0, 0),
	...
	return result
# Register our custom plugin before use.
cq.Workplane.fbcc_top_horizontal_struts = fbcc_top_horizontal_struts
...
def unit_cell(location, unit_cell_size, strut_radius, node_diameter):
	result = cq.Workplane("XY")
	result = (result
			  .union(fbcc_diagonals(unit_cell_size, strut_radius))
			  .union(fbcc_vertical_struts(unit_cell_size, strut_radius))
			  .union(fbcc_horizontal_diagonal_struts(unit_cell_size, strut_radius))
